...
; Description ...: 	This UDF is meant to be used by Lazstream. It might need editing in order to be used by other scripts.
;
;					Lazstream and all of its components are released under the GPLv2 License:
...
;					It's highly recommended to set TCPTimeout to a value higher than default (Lazstream uses 5000).
; Related .......: 	_NTRSendNFCPatch, TCPTimeout (Option)
; Link ..........:
; Example .......: 	See Lazstream's source code
; ===============================================================================================================================
Func _NTRInitRemoteplay($sIp, $bPriorityMode = 1, $iPriorityFactor = 5, $iQuality = 90, $iQosValue = 20)
	...
	;1 will always mean top screen and 0 bottom screen in this UDF and Lazstream's source code.
	;
